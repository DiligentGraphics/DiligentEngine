...
if "%num_args%" LSS "3" (
    ...
    echo.
    echo   test_all.bat config build_path golden_images_path
    echo.
    ...
    echo.
    echo Example:
    echo   test_all.bat Debug c:\Projects\DiligentEngine\build\Win64 c:\Projects\DiligentEngine\GoldenImages
    echo.
...
set API_TEST_EXE_PATH="%2\DiligentCore\Tests\DiligentCoreAPITest\%1\DiligentCoreAPITest.exe"
...
set golden_images_root_dir=%3
set golden_img_width=1024
set golden_img_height=768
(call ProcessGoldenImages.bat %2 Debug compare "" d3d11 d3d12 gl vk) || set APP_ERROR=!ERRORLEVEL!
